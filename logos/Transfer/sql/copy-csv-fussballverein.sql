...
COPY fussballverein (id, name, gruendungsdatum, website, email, telefonnummer, mitgliederanzahl, logo, erzeugt, aktualisiert, version) FROM '/csv/fussballverein.csv' (FORMAT csv, DELIMITER ';', HEADER true);
